...
import './style.css';
import { createBoard, setupPlayerBoard } from './factories/setup.js';
...
// Ensure messageElement is selected correctly
document.addEventListener('DOMContentLoaded', function() {
  ...
  function renderBoards() {
    ...
    createBoard(enemyBoardElement, enemyBoard.getBoard(), true); // Render the enemy board
  }
